        ...
        <div>
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <input style="margin-left: 10px;" type="checkbox" value="true" v-model="show"> Show Sale In %
                </div>
            </div>
                        ...
                        <table _a584de>
                            <thead>
                                <tr>
                                    ...
                                    <td>Qnty</td>
                                    <td>IC Rate</td>
                                    <td v-if="show">Sale In</td>
                                    <!--  <td v-if="show">Sale In Taka</td> -->
                                    <td>Unit Price</td>
                                    <td>Total</td>
                                </tr>
                            </thead>
                            <tbody>
                                <tr v-for="(product, sl) in cart">
                                    ...
                                    <td align="center">{{ product.Product_ASR != 0 ? product.Product_ASR : product.ic_rate}}</td>

                                    <td v-if="show" align="center">{{ parseFloat(((product.SaleDetails_Rate - (product.Product_ASR != 0 ? product.Product_ASR : product.ic_rate))/(product.Product_ASR != 0 ? product.Product_ASR : product.ic_rate))*100).toFixed(2) }} %</td>

                              <!--      <td  align="center">{{ parseFloat(parseFloat(product.SaleDetails_TotalAmount) - parseFloat(product.Product_ASR * product.SaleDetails_TotalQuantity)).toFixed(2) }}</td> -->

                                    <td align="center">{{ product.SaleDetails_Rate }}</td>
                    ...
                    <div class="col-xs-6">
                        <table _t92sadbc2>
                            ...
                            <tr>
                                ...
                                <td style="text-align:right">{{ (parseFloat(sales.SaleMaster_PaidAmount) + parseFloat(sales.returnAmount)).toFixed(2)}}</td>
                            </tr>
                            <tr>
