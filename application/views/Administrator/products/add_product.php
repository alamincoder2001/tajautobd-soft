				...
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<div class="row">
							...
							<div class="col-md-4">
								<input type="text" id="APR" v-on:input="calculateAPR" class="form-control" v-model="product.PPR_Percent" required>
							</div>
							<div class="col-md-4">
								<input type="text" class="form-control" v-on:input="calculateAPR" placeholder="APR" v-model="product.A_Product_Purchase_Rate" required>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<div class="row">
							...
							<div class="col-md-4">
								<input type="text" id="PSP" class="form-control" v-model="product.PSP_Percent" v-on:input="calculateASR" required>
							</div>
							<div class="col-md-4">
								<input type="text" class="form-control" v-on:input="calculateASR" placeholder="ASR" v-model="product.A_Product_SellingPrice" required>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<div class="row">
							...
							<div class="col-md-4">
								<input type="text" placeholder="Percent" class="form-control" v-model="product.PWR_Percent" required>
							</div>
							<div class="col-md-4">
								<input type="text" class="form-control" placeholder="Actual Rate" v-model="product.A_Product_WholesaleRate" required>
							</div>
						</div>
					</div>
				</div>
		...
		data() {
			return {
				product: {
					...
					PSP_Percent: 0,
					A_Product_SellingPrice: '',
					Product_WholesaleRate: 0,
					PWR_Percent: 0,
					A_Product_WholesaleRate: 0,
					ic_rate: '',
					Unit_ID: '',
					vat: 0,
					is_service: false
		...
		methods: {
			...
			calculateAPR() {
				if (event.target.id == 'APR') {
					this.product.A_Product_Purchase_Rate = (parseFloat(this.product.Product_Purchase_Rate) + ((parseFloat(this.product.Product_Purchase_Rate) * parseFloat(this.product.PPR_Percent)) / 100)).toFixed(2);
				} else {
					this.product.PPR_Percent = (((parseFloat(this.product.A_Product_Purchase_Rate) - parseFloat(this.product.Product_Purchase_Rate)) * 100) / parseFloat(this.product.Product_Purchase_Rate)).toFixed(2);
				}
			},
			calculateASR() {
				if (event.target.id == 'PSP') {
					this.product.A_Product_SellingPrice = (parseFloat(this.product.Product_SellingPrice) + ((parseFloat(this.product.Product_SellingPrice) * parseFloat(this.product.PSP_Percent)) / 100)).toFixed(2);
				} else {
					this.product.PSP_Percent = (((parseFloat(this.product.A_Product_SellingPrice) - parseFloat(this.product.Product_SellingPrice)) * 100) / parseFloat(this.product.Product_SellingPrice)).toFixed(2);
				}
			}
		}
	})
