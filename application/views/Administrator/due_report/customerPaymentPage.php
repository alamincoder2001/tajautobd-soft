				...
				<div class="row">
					<div class="col-md-5 col-md-offset-1">
						...
						<div class="form-group">
							...
							<label class="col-md-1">:</label>
							<div class="col-md-7">
								<input type="text" class="form-control" v-model="payment.CPayment_previous_due">
							</div>
						</div>
					</div>
...
<script>
	...
	new Vue({
		...
		computed: {
			...
			totalSum() {
				return parseFloat(this.payments.filter(t => t.CPayment_Addby.toLowerCase().includes(this.filter.toLowerCase())).reduce((p, c) => {
					return +p + +c.CPayment_amount
				}, 0)).toFixed(2);
			}
		},
		watch: {
